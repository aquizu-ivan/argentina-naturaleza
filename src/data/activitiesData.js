...
export const activitiesData = [
  {
    ...
    benefits: [
      "Activa circulación y movilidad al comenzar el día",
      "Respiración guiada para reducir estrés",
      "Conexión con el entorno natural del lago"
    ]
  },
  {
    ...
    benefits: [
      "Reduce la ansiedad mediante respiración y pausa",
      "Estimula los sentidos en un entorno seguro",
  ...
  },
  {
    ...
    benefits: [
      "Mejora fuerza y resistencia cardiovascular",
      "Moviliza articulaciones con bajo impacto",
      "Entrena al aire libre con estímulos cambiantes"
    ]
  },
  {
    ...
    benefits: [
      "Reduce el ritmo y baja pulsaciones",
      "Fortalece la consciencia corporal",
      "Conecta con el agua y el verde del delta"
    ]
  },
  {
    ...
    benefits: [
      ...
      "Invita a cerrar el día con calma y vistas amplias"
    ]
  }
];
