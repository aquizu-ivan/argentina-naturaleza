...
export const trailsData = [
  {
    ...
    benefits: [
      ...
      "Contacto con flora andina y lagunas glaciares"
    ]
  },
  {
    id: "cerro-campanario",
    ...
    benefits: [
      ...
      "Permite combinar con otras excursiones en el día"
    ]
  },
  {
    ...
    benefits: [
      "Entorno húmedo y sombreado para días calurosos",
      "Avistaje de aves y biodiversidad",
      "Miradores naturales hacia el valle"
    ]
  },
  {
    id: "cerro-banderita",
    ...
    benefits: [
      "Pendiente amable y constante",
      "Bosques de coníferas y arroyos claros",
      "Mirador amplio para descansar y picar algo"
    ]
  },
  {
    id: "laguna-esmeralda",
    ...
    benefits: [
      "Colores intensos de agua y bosque",
      "Terreno variado y entretenido",
